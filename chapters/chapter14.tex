...
\[ n = 2k+1, k\in\N_0 \Rightarrow i^n = i^{2k+1} = i^(2k) i = {(-1)}^k i \]
...
\[ = \limes{L} \left( \sum_{\substack{0\leq 2k \leq L\\ k\in\N_0}} {(-1)}^k \frac{z^{2k}}{(2k)!} + i \sum_{\substack{0\leq 2k+1 \leq L\\ k\in\N_0 }} {(-1)}^k \frac{z^{2k+1}}{(2k+1)!} \right) (*) \]
...
\begin{prosa}
    ...
    \[ e^{it} = \cos t + i \sin t, t\in\R \text{(Eulersche Formel)} \]
    ...
    \[ \Rightarrow \overline{\exp(z)} = \exp(\overline{z}) \,\forall \, z\in\C. \]
    Somit folgt: \( \overline{e^{it}} = \overline{\exp(it)} = \exp(\overline{it}) = \exp(\minus it) = e^{\minus i t} \,\forall \, t\in\R \).\\
    Daher 
    \begin{align*}
...
\begin{bew}
    ...
    \begin{enumerate}[(a)]
        ...
        Dann konvergiert (wegen \( (*) \)) \( \sum_{n=0}^\infty a_n z^n \,\forall \, z\in\C \)
        \[ \Rightarrow R = \infty. \]
...
\end{kor}
\begin{bew}
    Da \( n^{1/n} \rightarrow 1 \) für \( n\rightarrow \infty \)
    \[ \limessup{n} \sqrt[n]{\abs{a_n}} = \limessup{n} \sqrt[n]{n \cdot \abs{a_{n-1}}}. \]
\end{bew}
\begin{lem}
    Konvergiert \( \sum_{n=0}^\infty a_n z^n \) für einen \( z = z_1 \neq 0 \), 
    ...
    \[ \abs{ \sum_{n=0}^\infty a_n z^n } \leq M(r) \,\forall \, \abs{z} < r. \]
\end{lem}
\begin{bew}
    ...
    \[ \Rightarrow \abs{a_n z^n} \leq K \theta^n \,\forall \, \abs{z}\leq r, \theta := \frac{r}{\abs{z_1}} < 1 \]
    ...
    Dann gilt also
    \[ \abs{ \sum_{n=0}^\infty a_n z^n } \leq M(r) \,\forall \, \abs{z} \leq r. \]
\end{bew}
\begin{kor}
    Ang.\  \( \sum_{n=0}^\infty a_n z^n \) konvergiert für ein \( z = z_1 \neq 0 \). Dann gibt es zu jedem
    \[ 0 < r < \abs{z_1}, k\in\N_0 \]
    ein \( M(r,k) > 0 \) mit
    \[ \abs{ \sum_{n=1}^\infty a_n z^n } \leq < M(r,k) \abs{z}^{k+1} \, \forall \, \abs{z}\leq r \]
\end{kor}
\begin{bew}
    ...
    \[ \abs{ \sum_{n=0}^\infty a_n z^{n-(k+1)} } = \abs{ \sum_{n=0}^\infty a_{n+k+1} \abs{z}^n } \leq M(k,r) \,\forall \, \abs{z} \leq r \]
    \[ \Rightarrow \abs{ \sum_{n=k+1}^\infty a_n z^n } = \abs{z}^{k+1} \abs{ \sum_{n=k+1}^\infty a_n z^{n-(k+1)} } \leq \abs{z}^{k+1} M(k,r) \,\forall \, \abs{z} < r. \]
\end{bew}
\end{document}