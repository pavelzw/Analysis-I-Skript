...
\begin{defi}[Uneigentliche Konvergenz]
	...
	Schreiben \( \limits_{n\rightarrow\infty} a_n = \infty \) oder \( a_n \rightarrow +\infty, n\rightarrow \infty \)
	Analog für \( \limits_{n\rightarrow\infty} a_n = -\infty \), falls 
	\[ \forall R<0 \exists K\in\N: a_n < R \forall n\geq K. \]
\end{defi}
\begin{bsp}
	Ist \(a>1 \Rightarrow\limits_{n\rightarrow\infty}q^n = +\infty, 0< \frac{1}{q} < 1. \)
\end{bsp}
\begin{bew}
	...
	\begin{align*}
		...
		&q=1 &\Rightarrow \limits_{n\rightarrow\infty}q^n = 1.\\
