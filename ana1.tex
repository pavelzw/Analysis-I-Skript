...
\begin{bew}
	...
	\( \overset{Mon. Konv.}{\Rightarrow} \lim\limits_{n\rightarrow\infty} e_n \) existiert \(\leq 2,75\).\\
	...
	\end{align*}
	\( \Rightarrow \lim\limits_{n\rightarrow\infty} f_n \) existiert!
\end{bew}
\begin{defi}[Eulersche Zahl]
	\( e:= \lim\limits_{n\rightarrow\infty} (1+\frac{1}{n})^n \) (\(\leq 2,75\))
\end{defi}
\begin{bem}
	\begin{enumerate}
		\item Es gilt auch \( \lim\limits_{n\rightarrow\infty} (1+\frac{x}{n})^n \) exist. \( \forall x\in\R \) (H.A.)
		\item Alternative Darstellung für \(e\):\\
		Hatten gesehen: \(f_n \leq e_n = \sum_{k=0}^{n} \frac{1}{k!} \quad \forall n \)\\
		\(e_n \leq 2,75, e_{n+1} > e_n \)\\
		\( \Rightarrow \) es existiert \( \lim\limits_{n\rightarrow\infty} e_n = \lim\limits_{n\rightarrow\infty} \sum_{k=0}^{n} \frac{1}{k!} =: \sum_{k=0}^{\infty} \frac{1}{k!} \) und somit auch \(e = \lim\limits_{n\rightarrow\infty} f_n\leq \lim\limits_{n\rightarrow\infty} e_n = \sum_{k=0}^{\infty} \frac{1}{k!} \).
	\end{enumerate}
	Beobachtung: 
	\[ f_n = (1+\frac{1}{n})^n = \sum_{k=0}^{n} \frac{1}{k!} \underbrace{\frac{n}{n}\frac{(n-1)}{n} \ldots\frac{n-k+1}{n}}_{\geq 0} , \quad(1+\frac{1}{n}^n = \sum_{k=0}^{n} \binom{n}{k} \frac{1}{n^k} \]
	Nehme \(m\in\N\) fest.
	...
	\[e_m \leq \lim\limits_{n\rightarrow\infty} f_n = e \]
