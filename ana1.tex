...
\begin{bsp}
	...
	\(k = 10\)\\
	Behauptung: \(0,99999 = 1\)
	\begin{align*}
		0,9999 &= \limes{n} \sum_{j=1}^{n} \frac{9}{10^j}\\
		&=\limes{n} \frac{9}{10}\cdot \sum_{j=0}^{n-1}(\frac{1}{10})^j\\
...
\begin{bew}
	...
	\begin{tikzpicture}[scale = 8]
		...
		\draw (1,0) node {\(]\)} node[below = 2mm] {\(b\)};
		\draw (1/2,0) node {\(]\)} node[below = 2mm] {\(\frac{a+b}{2}\)};
		\draw (1/4,0) node {\([\)};
