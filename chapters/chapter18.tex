...
\begin{bew}
    Später.
\end{bew}
\begin{bew}[von Satz 7]%href TODO
    ...
    y_2 = f(x_2). \]
    \[ f \text{ stetig } \overunderset{\text{Zwischen-}}{
        \text{wertsatz}}{\Rightarrow} 
    \exists \, x_1 < x < x_2: f(x) = c. \]
    \[ \Rightarrow c \in J = f(I). \]
    \[ \Rightarrow [y_1, y_2] \subset J = f(I). \]
    \[ J \text{ ist ein Intervall.} \]
    \[ \overset{\text{Lemma 8}}{\Rightarrow} \exists \, \alpha := 
    ...
    Funktionswert.\\
    O.\ B.\ d.\ A.: linksseitiger Grenzwert.
